...
public class Pokemon {
	...
	public Pokemon(String name, Type type) {
		this.name = name;
		this.type = type; //TODO ERROR: type wird nicht übergeben!!!
	...
	public double averageForce() {
		...
		double sumScores = 0; //TODO: ERROR sumScores muss mit 0 initialisiert werden
			...
			if (!this.getCompetitions().isEmpty()) {
				...
				for (Competition c : this.getCompetitions()) {
					...
					nrOfValidScores++;
                            ...
                            //TODO ERROR Rückgabe ist 0 falls noch kein Competition stattgefunden hat.			    			    
			    return 0;
		...
		return averageForce; //TODO ERROR Falscher Rückgabe Wert
	}
